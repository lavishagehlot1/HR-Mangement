...
import { applyLeaveSchema, leaveIdSchema } from '../validations/leaveValidation.js';
const leaveRoutes=express.Router();
leaveRoutes.use(authorization)
leaveRoutes.post('/apply/leave',
    authorize("employee"),
...
leaveRoutes.put('/approveLeave/:id',
    authorize("admin","HR"),
    validate({params:leaveIdSchema})
    ,approveLeaveRequestById);

leaveRoutes.put('/reject/:id',
    authorize("admin","HR"),
    validate({params:leaveIdSchema}),
    rejectLeaveById)
