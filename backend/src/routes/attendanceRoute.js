...
import { employee_check_in, employee_check_out, todaysAttendance, view_all_attendance, view_own_attendance } from '../controller/attendanceController/attendanceController.js';
...
attendanceRoute.get('/attendance/todaysAttendance',authorize('employee'),todaysAttendance);
